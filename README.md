# Feedback System (Örnek)

<div align="center">

[![GitHub](https://img.shields.io/badge/GitHub-BKT-DevOps-181717?style=flat-square&logo=github)](https://github.com/BKT-DevOps/feedback-service)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

**Part of [Feedback System](docs/Project-Definition.md)**
...
> **ÖNEMLİ:** Bu repository **Feedback System** projesinin bir parçasıdır. Proje hakkında detaylı bilgi için [`docs/Project-Definition.md`](docs/Project-Definition.md) dosyasına bakın.
...
```bash
git clone https://github.com/BKT-DevOps/feedback-service.git
cd feedback-service
...
> **IMPORTANT:** This repository is part of **Feedback System** project. See [`docs/Project-Definition.md`](docs/Project-Definition.md) for details.
